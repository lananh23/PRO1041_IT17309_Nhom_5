 ...
 * @author Admin
 */
public class FrmDoiHang extends javax.swing.JFrame {
    ...
    private void loadTableHD(ArrayList<ManageHoaDon> list){
        ...
        for(ManageHoaDon hd : list){
            dtm.addRow(new Object[]{
                hd.getMaHD(), hd.getMaND(),  hd.getMaKH(),hd.getMaHD_2()
            });
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDoiHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDoiHang().setVisible(true);
            }
        });
    }
